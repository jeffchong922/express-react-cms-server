...
const POSITIONS_DB_URL = process.env.POSITIONS_DB_URL || DEFAULT_DB_URL
const POSITIONS_DB_NAME = process.env.POSITIONS_DB_NAME || DEFAULT_DB_NAME
const POSITIONS_DB_COL_NAME = process.env.POSITIONS_DB_COL_NAME || 'positions'
...
logger.info(`
  ...
  POSITIONS_DB_URL: ${POSITIONS_DB_URL}
  POSITIONS_DB_NAME: ${POSITIONS_DB_NAME}
  POSITIONS_DB_COL_NAME: ${POSITIONS_DB_COL_NAME}
`)
